...
class ZPop {
    ...
    doShow(items) {
        ...
        if (this.options.onSearch) {
            ...
            html += "<form class='form-inline zpop-search-container' novalidate>";
            html += "<input type='text' placeholder='" + this.options.searchPlaceholder + "' class='form-control zpop-search' />";
            html += "<i class='fas fa-search fa-lg float-end zpop-search-icon searcher'></i>";
            html += "<i class='fas fa-times fa-lg float-end zpop-search-icon clearer' style='color:gray; cursor:pointer; display:none;'></i>";
            html += "</form>";
        }
        this.pop.html(html);
