class Dashboard extends ZCustomController {
    ...
    builComponentNode(component) {
        ...
        if (component.type == "dimFilter") {
            return {
                id:component.id, 
                label:"${" + component.paramName + "}", 
                icon:"fas fa-filter",
                items:false,
                _type:component.type,
                source:component
            }
        } else if (component.type == "dimRowSelector") {
            return {
                id:component.id, 
                label:"${" + component.paramName + "}", 
        ...
        } else if (component.type == "timeSerie") {
            return {
                id:component.id, 
                label:"Serie Tiempo", 
        ...
        } else if (component.type == "dimSerie") {
            return {
                id:component.id, 
                label:"Barras por Dimensiones", 
                icon:"fas fa-chart-simple",
                items:false,
                _type:component.type,
                source:component
            }
        } else if (component.type == "dimTable") {
            return {
                id:component.id, 
                label:"Tabla por Dimensiones", 
        ...
        } else if (component.type == "timeDim") {
            return {
                id:component.id, 
                label:"Dimension en Tiempo", 
                icon:"fas fa-timeline",
                items:false,
                _type:component.type,
                source:component
            }
        } else if (component.type == "forceDirectedTree") {
            return {
                id:component.id, 
                label:"Árbol Direccional Dirigido", 
