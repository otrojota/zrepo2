class ZBootstrapTable extends ZController {
    onThis_init() {
        ...
        this.detailsTogglerOpenIcon = this.getAttribute("data-z-details-toggler-open-icon") || "fas fa-edit";
        this.detailsTogglerCloseIcon = this.getAttribute("data-z-details-toggler-close-icon") || "fas fa-caret-up";
